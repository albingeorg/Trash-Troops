...
#ch {
 ...
 overflow: hidden;
   ...
   <body> 
   <div class="sidebar">
  <a href="http://localhost/Waste_Website/waste-management-system/index.html"  class="fa fa-home"><strong> Home  <img src="Logo_Trash.PNG" alt="LOGO"heigth='60'width='80'class='logo1'>
 </strong></a>
  <!-- <a href="#news">News</a>
